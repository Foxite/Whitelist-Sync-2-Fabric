...
public class PostgreSqlService implements BaseService {
	...
	public PostgreSqlService() {
		this.url = "jdbc:postgresql://" + ModConfig.POSTGRESQL_IP.get() + ":" + ModConfig.POSTGRESQL_PORT.get() + "/" + ModConfig.POSTGRESQL_DB_NAME.get();
		this.username = ModConfig.POSTGRESQL_USERNAME.get();
		this.password = ModConfig.POSTGRESQL_PASSWORD.get();
	}
